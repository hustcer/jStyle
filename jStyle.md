...
* 目前系统采用类库列表：
  ...
  1. jQuery
  1. 绘图类库: d3.js/jit
  1. 基于d3进一步封装的类库: nvd3.js
  1. 非ExtJs页面autocomplete类下拉列表: select2.js
  1. Grid拖拽布局: gridster.js
  1. 代码高亮着色编辑器: codemirror
  1. 非ExtJs页面弹出框: jquery.simplemodal.js
  1. 非ExtJs页面JSON解析: json2.js
  1. 键盘快捷键处理: mousetrap.js
